<?php
    $redirect_url = isset($_SESSION['user']) ? 'profile.php' : 'login.php';
?>
...
<div class="top-nav d-flex align-items-center justify-content-between w-100">
    <div class="basic-info d-flex gap-4 flex-wrap ps-3">
        <div class="top-nav-item d-flex">
            ...
            <a href="mailto:a.saurov2016@gmail.com" class="top-nav-item-text text-light ms-2">
                a.saurov2016@gmail.com
            </a>
        </div>
        ...
        <div class="top-nav-item d-flex">
            ...
            <a href="tel:+880 1642-005775" class="top-nav-item-text text-light ms-2">
                +880 1642-005775
            </a>
        </div>
