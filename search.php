<?php
    ...
    if (!empty($duration)) {
        $duration_conditions = [];
        if (in_array('1-7', $duration)) $duration_conditions[] = "tp.duration_in_days BETWEEN 1 AND 7";
        if (in_array('8-14', $duration)) $duration_conditions[] = "tp.duration_in_days BETWEEN 8 AND 14";
        if (in_array('15+', $duration)) $duration_conditions[] = "tp.duration_in_days >= 15";
